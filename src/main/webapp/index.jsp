        ...
        <div id="charSettings">
            ...
            <div id="datacronsCheckboxDiv" class="setting-expandable spawns-popup spawns-popup-hidden" onclick="DomController.userInput(this, 'popupInteriorClick', event)">
                ...
                <div class="setting-extra setting-extra-collapsed popup-volatile popup-hidden">
                    <div class="setting">
                        <input type="checkbox" checked id="datacronsCheckboxOnderon" class="datacrons-checkbox" onchange="Settings.updateDatacrons(this)">
                        <label class="label-single-line" for="datacronsCheckboxOnderon">Onderon</label>
                    </div>
                    <div class="setting">
            ...
            <div id="stimDiv">
                ...
                <span class="stim-group stim-group-new">
                ...
                <span class="stim-group stim-group-old">
                    <img onclick="DomController.userInput(this, 'stimClick', event)" class="button-stim" src="images/items50/stim_blue.png" data-stim-type="old_blue" />
                    <img onclick="DomController.userInput(this, 'stimClick', event)" class="button-stim" src="images/items50/stim_yellow.png" data-stim-type="old_yellow" />
                    <img onclick="DomController.userInput(this, 'stimClick', event)" class="button-stim" src="images/items50/stim_red.png" data-stim-type="old_red" />
                </span>
            </div>
        </div>
